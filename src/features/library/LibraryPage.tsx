...
export function LibraryPage() {
  ...
  return (
    <PageFrame>
      ...
      >
        <div className="grid grid-cols-[42px_minmax(0,1.5fr)_minmax(140px,.8fr)_70px] gap-3 border-b border-[var(--line)] px-3 py-2.5 text-[8px] font-semibold uppercase tracking-[0.12em] text-white/17">
          ...
          tracks.slice(0, visible).map((track, index) => {
            ...
            return (
              <button
                ...
                className={`group grid w-full grid-cols-[42px_minmax(0,1.5fr)_minmax(140px,.8fr)_70px] items-center gap-3 border-b border-white/[0.025] px-3 py-2 text-left transition-colors last:border-0 ${
              ...
              >
                ...
                <span className="truncate text-[9px] text-white/19">{track.albumTitle ?? "—"}</span>
